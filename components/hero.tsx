...
export function Hero() {
  ...
  return (
    <section id="home" className="relative bg-gradient-to-br from-background to-muted py-12 md:py-20 lg:py-32">
            ...
            <div className="space-y-4">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-balance font-[family-name:var(--font-playfair)] leading-tight">
                ...
                <span className="text-primary">
                  Solutions
                  <span className="absolute left-0 -bottom-1 h-1 w-full rounded bg-primary/40" />
                </span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground text-pretty leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Premium quality plastic products for industrial and commercial applications. Trusted by businesses
